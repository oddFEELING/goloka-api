...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/admin/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form action="{{ route('surveyor.password.verify-code') }}" method="POST" class="cmn-form mt-30">
                @csrf
                ...
                <a href="{{ route('surveyor.password.reset') }}" class="text-muted text--small">@lang('Try to send
                    again')</a>
            </form>
        </div>
    </div><!-- login-area end -->
