...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/surveyor/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form action="{{route('surveyor.verify_email')}}" method="POST" class="cmn-form mt-30">
                @csrf
                ...
                <div class="form-group align-items-center">
                        <p>@lang('Please check including your Junk/Spam Folder')</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('surveyor.send_verify_code')}}?type=email" class="text-muted text--small">@lang('Try to send
                                again')</a>
            </form>
        </div>
    </div><!-- login-area end -->
