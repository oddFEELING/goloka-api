                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($transactions as $trx)
                                <tr>
                                    ...
                                    @elseif ($trx->surveyor_id)
                                        <td data-label="@lang('Username')"><a href="{{ route('admin.surveyors.detail', $trx->surveyor_id) }}">{{ @$trx->surveyor->username }}</a></td>
                                    @endif
...
@push('breadcrumb-plugins')
    ...
    @elseif(request()->routeIs('admin.report.transaction.search'))
        <form action="{{ route('admin.report.transaction.search') }}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append">
                <input type="text" name="search" class="form-control" placeholder="@lang('TRX / Username')" value="{{ $search ?? '' }}">
                <div class="input-group-append">
    ...
    @elseif(request()->routeIs('admin.report.surveyor.transaction'))
        <form action="{{ route('admin.report.surveyor.transaction.search') }}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append">
                <input type="text" name="search" class="form-control" placeholder="@lang('TRX / Username')" value="{{ $search ?? '' }}">
                <div class="input-group-append">
                    <button class="btn btn--primary" type="submit"><i class="fa fa-search"></i></button>
    ...
    @elseif(request()->routeIs('admin.report.surveyor.transaction.search'))
        <form action="{{ route('admin.report.surveyor.transaction.search') }}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append">
                <input type="text" name="search" class="form-control" placeholder="@lang('TRX / Username')" value="{{ $search ?? '' }}">
                <div class="input-group-append">
