...
<div class="row justify-content-center">
    @if(request()->routeIs('admin.deposit.list') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.surveyors.deposits') || request()->routeIs('admin.deposit.dateSearch') || request()->routeIs('admin.surveyors.deposits.method'))
                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                @if(!request()->routeIs('admin.surveyors.deposits') && !request()->routeIs('admin.surveyors.deposits.method'))
                                ...
                                @elseif(request()->routeIs('admin.deposit.list') || request()->routeIs('admin.deposit.search') || request()->routeIs('admin.surveyors.deposits') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.deposit.dateSearch') || request()->routeIs('admin.surveyors.deposits.method'))
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                @if(!request()->routeIs('admin.surveyors.deposits') && !request()->routeIs('admin.surveyors.deposits.method'))
                                <td data-label="@lang('Username')"><a href="{{route('admin.surveyors.detail',$deposit->surveyor_id)}}">{{ $deposit->surveyor->username }}</a></td>
                                @endif
                                <td data-label="@lang('Method')">
                                    @if(request()->routeIs('admin.surveyors.deposits') || request()->routeIs('admin.surveyors.deposits.method'))
                                   <a href="{{ route('admin.surveyors.deposits.method',[$deposit->gateway->alias,@$type?$type:'all',$surveyorId]) }}">{{ __($deposit->gateway->name) }}</a>
                                   @else
