            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.category*')}}">
                    <a href="{{route('admin.category')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Survey Category')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.manage.survey*',3)}}">
                        ...
                        <span class="menu-title">@lang('Manage Survey') </span>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.manage.survey*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.manage.survey.pending')}}">
                                <a href="{{route('admin.manage.survey.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                    @if($pending_survey_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_survey_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.manage.survey.rejected')}}">
                                <a href="{{route('admin.manage.survey.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.surveyors*',3)}}">
                        ...
                        <span class="menu-title">@lang('Manage Surveyors')</span>

                        @if($banned_surveyors_count > 0 || $email_unverified_surveyors_count > 0 || $sms_unverified_surveyors_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.all')}} ">
                                <a href="{{route('admin.surveyors.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Surveyors')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.active')}} ">
                                <a href="{{route('admin.surveyors.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Surveyors')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.banned')}} ">
                                <a href="{{route('admin.surveyors.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Surveyors')</span>
                                    @if($banned_surveyors_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_surveyors_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.surveyors.emailUnverified')}}">
                                <a href="{{route('admin.surveyors.emailUnverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>

                                    @if($email_unverified_surveyors_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$email_unverified_surveyors_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.smsUnverified')}}">
                                <a href="{{route('admin.surveyors.smsUnverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('SMS Unverified')</span>
                                    @if($sms_unverified_surveyors_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_surveyors_count}}</span>
                                    @endif
                                </a>
                            </li>


                            <li class="sidebar-menu-item {{menuActive('admin.surveyors.email.all')}}">
                                <a href="{{route('admin.surveyors.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.report.transaction','admin.report.transaction.search'])}}">
                                <a href="{{route('admin.report.transaction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User Transaction')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.report.surveyor.transaction','admin.report.surveyor.transaction.search'])}}">
                                <a href="{{route('admin.report.surveyor.transaction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Surveyor Transaction')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.surveyor.login.history','admin.report.surveyor.login.ipHistory'])}}">
                                <a href="{{route('admin.report.surveyor.login.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Surveyor Login History')</span>
                                </a>
                            </li>
