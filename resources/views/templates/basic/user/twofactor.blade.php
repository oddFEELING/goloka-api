                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group mx-auto text-center">
                                    <a href="#0"  class="btn btn--base btn-block " data-toggle="modal" data-target="#disableModal">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="key" value="{{$secret}}" class="form-control bg--primary text-white" id="referralURL" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text copytext bg--primary text-white" id="copyBoard" onclick="myFunction()"> <i class="fa fa-copy"></i> </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mx-auto text-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-3">
                    <div class="card">
                        ...
                        <div class=" card-body">
                            ...
                            <a class="btn btn--base btn-lg mt-3" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">@lang('Download App')</a>
                        </div>
            ...
            <div class="modal-content ">
                ...
                <form action="{{route('user.twofactor.enable')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn--base" data-dismiss="modal">@lang('close')</button>
