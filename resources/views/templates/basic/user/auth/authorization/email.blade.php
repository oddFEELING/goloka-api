                ...
                <div class="col-lg-6">
                    <div class="account-form-area bg-overlay-black section--bg">
                        ...
                        <div class="account-header text-center">
                            <h2 class="title">@lang('Please Verify Your Email to Get Access')</h2>
                            <h3 class="sub-title">@lang('Your Email') : {{auth()->user()->email}}</h3>
                        </div>
                        <form class="account-form" method="POST" action="{{route('user.verify_email')}}">
                            ...
                            <div class="row ml-b-20">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input type="text" class="form-control form--control" name="email_verified_code[]" required>
                                </div>
                                <div class="col-lg-12 form-group">
                                ...
                                <div class="col-lg-12 form-group">
                                    <div class="checkbox-wrapper d-flex flex-wrap align-items-center">
                                        <div class="checkbox-item">
                                            <label><a href="{{route('user.send_verify_code')}}?type=email">@lang('Resend code')</a></label>
                                        </div>
                                    </div>
                                </div>
