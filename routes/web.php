...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin','access'])->group(function () {
        ...
        // Surveyors Manager
        Route::get('surveyors', 'ManageSurveyorsController@allSurveyors')->name('surveyors.all');
        Route::get('surveyors/active', 'ManageSurveyorsController@activeSurveyors')->name('surveyors.active');
        Route::get('surveyors/banned', 'ManageSurveyorsController@bannedSurveyors')->name('surveyors.banned');
        Route::get('surveyors/email-verified', 'ManageSurveyorsController@emailVerifiedSurveyors')->name('surveyors.emailVerified');
        Route::get('surveyors/email-unverified', 'ManageSurveyorsController@emailUnverifiedSurveyors')->name('surveyors.emailUnverified');
        Route::get('surveyors/sms-unverified', 'ManageSurveyorsController@smsUnverifiedSurveyors')->name('surveyors.smsUnverified');
        Route::get('surveyors/sms-verified', 'ManageSurveyorsController@smsVerifiedSurveyors')->name('surveyors.smsVerified');

        Route::get('surveyors/{scope}/search', 'ManageSurveyorsController@search')->name('surveyors.search');
        Route::get('surveyor/detail/{id}', 'ManageSurveyorsController@detail')->name('surveyors.detail');
        Route::post('surveyor/update/{id}', 'ManageSurveyorsController@update')->name('surveyors.update');
        Route::post('surveyor/add-sub-balance/{id}', 'ManageSurveyorsController@addSubBalance')->name('surveyors.addSubBalance');
        Route::get('surveyor/send-email/{id}', 'ManageSurveyorsController@showEmailSingleForm')->name('surveyors.email.single');
        Route::post('surveyor/send-email/{id}', 'ManageSurveyorsController@sendEmailSingle')->name('surveyors.email.single');
        Route::get('surveyor/transactions/{id}', 'ManageSurveyorsController@transactions')->name('surveyors.transactions');
        Route::get('surveyor/deposits/{id}', 'ManageSurveyorsController@deposits')->name('surveyors.deposits');
        Route::get('surveyor/deposits/via/{method}/{type?}/{userId}', 'ManageSurveyorsController@depViaMethod')->name('surveyors.deposits.method');
        Route::get('surveyor/{id}/survey/all', 'ManageSurveyorsController@surveyAll')->name('surveyors.survey.all');
